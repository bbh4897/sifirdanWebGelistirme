    ...
    public class BlogInitializer:DropCreateDatabaseIfModelChanges<BlogContext>
    {
        protected override void Seed(BlogContext context)
        {
            ...
            List<Blog> bloglar = new List<Blog>()
            {
               ...
               new Blog() {Baslik="Generic List Hakkında", Aciklama="Acıklama 2",EklenmeTarihi=DateTime.Now.AddDays(-30), Anasayfa=true, Onay=true, Icerik="Icerık 2", Resim="2.jpg", CategoryId=2},
               ...
               new Blog() {Baslik="Android Delegates Hakkında", Aciklama="Acıklama 5",EklenmeTarihi=DateTime.Now.AddDays(-1), Anasayfa=true, Onay=true, Icerik="Icerık 5", Resim="5.jpg", CategoryId=1},
               ...
               new Blog() {Baslik="Ayrık Matematik Delegates Hakkında", Aciklama="Acıklama 8",EklenmeTarihi=DateTime.Now.AddDays(-10), Anasayfa=true, Onay=true, Icerik="Icerık 8", Resim="8.jpg", CategoryId=2}
            };
