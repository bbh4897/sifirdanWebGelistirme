    ...
    public class BlogInitializer:DropCreateDatabaseIfModelChanges<BlogContext>
    {
        protected override void Seed(BlogContext context)
        {
            ...
            List<Blog> bloglar = new List<Blog>()
            {
               ...
               new Blog() {Baslik="Ayrık Matematik Delegates Hakkında", Aciklama="Acıklama 8",EklenmeTarihi=DateTime.Now.AddDays(-10), Anasayfa=false, Onay=true, Icerik="Icerık 8", Resim="8.jpg", CategoryId=21},
            };
